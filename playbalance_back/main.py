...
from app.interfaces.routes import auth, booking, group, invites, notification, transaction, user, upload, playbalance_admin
...
app.include_router(playbalance_admin.router)
