          ...
          {myTeamIndex === null && isMyLeftOut && Boolean(teams.leftOut?.length) && (
            <Card className="bg-zinc-800/80 border-zinc-700">
              <CardHeader className="space-y-1">
                <CardTitle className="text-white">Reservas do sorteio</CardTitle>
                <CardDescription>Jogadores confirmados que não couberam nos times.</CardDescription>
              </CardHeader>
        ...
        >
          <SheetHeader className="border-b border-zinc-800 px-6 py-4 text-left">
            ...
            <SheetDescription className="text-left text-xs text-zinc-400">
              Gerencie confirmados, edite habilidades e adicione jogadores do grupo.
            </SheetDescription>
          </SheetHeader>
